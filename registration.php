...
<?php 
  if (array_key_exists('add_Student',$_POST))
  {
        ...
        $insert_Add_person=$db_connect->query("CALL SP_Add_person(@Input_Last_Name,@Input_First_Name,@Input_Middle_Name,@Input_Extension_Name,@Input_Sex,@Input_Birth_Date,@Input_Age,@Input_Home_Address,@Input_Civil_Status,@Input_Religion,@Input_Nationality,@Input_Boarding_Address,@Input_Contact_Number,@Input_Email_Address)");

        $result= $db_connect->query($insert_Add_person);
